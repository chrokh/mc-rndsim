...
df$p0_intervention_spend  <- (df$i1_cost0  - df$cost0)  + (df$i1_revenue0  - df$revenue0)
df$p1_intervention_spend  <- (df$i1_cost1  - df$cost1)  + (df$i1_revenue1  - df$revenue1)
df$p2_intervention_spend  <- (df$i1_cost2  - df$cost2)  + (df$i1_revenue2  - df$revenue2)
df$p3_intervention_spend  <- (df$i1_cost3  - df$cost3)  + (df$i1_revenue3  - df$revenue3)
df$p4_intervention_spend  <- (df$i1_cost4  - df$cost4)  + (df$i1_revenue4  - df$revenue4)
df$p5_intervention_spend  <- (df$i1_cost5  - df$cost5)  + (df$i1_revenue5  - df$revenue5)
df$p6_intervention_spend  <- (df$i1_cost6  - df$cost6)  + (df$i1_revenue6  - df$revenue6)
df$p7_intervention_spend  <- (df$i1_cost7  - df$cost7)  + (df$i1_revenue7  - df$revenue7)
df$p8_intervention_spend  <- (df$i1_cost8  - df$cost8)  + (df$i1_revenue8  - df$revenue8)
df$p9_intervention_spend  <- (df$i1_cost9  - df$cost9)  + (df$i1_revenue9  - df$revenue9)
df$p10_intervention_spend <- (df$i1_cost10 - df$cost10) + (df$i1_revenue10 - df$revenue10)
df$p11_intervention_spend <- (df$i1_cost11 - df$cost11) + (df$i1_revenue11 - df$revenue11)
df$p12_intervention_spend <- (df$i1_cost12 - df$cost12) + (df$i1_revenue12 - df$revenue12)
df$p13_intervention_spend <- (df$i1_cost13 - df$cost13) + (df$i1_revenue13 - df$revenue13)
df$p14_intervention_spend <- (df$i1_cost14 - df$cost14) + (df$i1_revenue14 - df$revenue14)
df$p15_intervention_spend <- (df$i1_cost15 - df$cost15) + (df$i1_revenue15 - df$revenue15)
